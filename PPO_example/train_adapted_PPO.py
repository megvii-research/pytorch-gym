...
def train_adapted_PPO(env='HalfCheetahBulletEnv-v0', load_model=False, render=False, save_every=None, gamma=0.99,
                      lam=0.98):
    # set seed
    torch.manual_seed(2)
...
if __name__ == '__main__':
    ...
    train_adapted_PPO(env=args.env, gamma=args.gamma, lam=args.lam, save_every=args.save_every, render=args.render,
